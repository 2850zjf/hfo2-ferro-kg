        ...
        row.update(
            {
                ...
                "physical_soft_warnings": f"physical_constraint_error:{str(exc)[:120]}",
                "physical_risk_flags": "",
...
def _accepted_reviewed_fact_rows(db_path: Path | None = None) -> list[dict[str, Any]]:
    ...
    for row in rows:
        ...
        row_out = {
                ...
                "composition_descriptor": material.get("composition_descriptor") or "",
                "layer_sequence": material.get("layer_sequence") or "",
                "superlattice_period": material.get("superlattice_period") or "",
                ...
                "annealing_method": sample.get("annealing_method") or "",
                "oxygen_partial_pressure": sample.get("oxygen_partial_pressure") or "",
                "oxygen_vacancy_context": sample.get("oxygen_vacancy_context") or "",
                "oxygen_reservoir": sample.get("oxygen_reservoir") or "",
                "interface_layer": sample.get("interface_layer") or "",
                "interface_termination": sample.get("interface_termination") or "",
                "growth_orientation": sample.get("growth_orientation") or "",
                "strain_state": sample.get("strain_state") or "",
                ...
                "phase_fraction": phases[0].get("phase_fraction") if phases else "",
                "crystal_orientation": phases[0].get("crystal_orientation") if phases else "",
                "domain_orientation": phases[0].get("domain_orientation") if phases else "",
                ...
                "condition": _json(
                    {
                        ...
                        "measurement_state": prop.get("measurement_state"),
        ...
        for index, record in enumerate(payload.get("benchmark_records") or []):
            ...
            for target_name, target in outputs.items():
                ...
                row_out = {
                        ...
                        "composition_descriptor": inputs.get("composition_descriptor") or "",
                        "layer_sequence": inputs.get("layer_sequence") or "",
                        "superlattice_period": inputs.get("superlattice_period") or "",
                        ...
                        "annealing_method": inputs.get("annealing_method") or "",
                        "oxygen_partial_pressure": inputs.get("oxygen_partial_pressure") or "",
                        "oxygen_vacancy_context": inputs.get("oxygen_vacancy_context") or "",
                        "oxygen_reservoir": inputs.get("oxygen_reservoir") or "",
                        "interface_layer": inputs.get("interface_layer") or "",
                        "interface_termination": inputs.get("interface_termination") or "",
                        "growth_orientation": inputs.get("growth_orientation") or "",
                        "strain_state": inputs.get("strain_state") or "",
                        ...
                        "phase_fraction": inputs.get("phase_fraction") or "",
                        "crystal_orientation": inputs.get("crystal_orientation") or inputs.get("orientation") or "",
                        "domain_orientation": inputs.get("domain_orientation") or "",
...
def _sample_link_rows(db_path: Path | None = None) -> list[dict[str, Any]]:
    ...
    for row in rows:
        ...
        row_out = {
            ...
            "phase_fraction": phase.get("phase_fraction") or "",
            "crystal_orientation": phase.get("crystal_orientation") or "",
            "domain_orientation": phase.get("domain_orientation") or "",
